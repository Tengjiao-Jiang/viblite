%% Line tracking technique 1.1
%
% Line-tracking technique is designed for detecting and tracking a linear 
% object, e.g. a railway catenary wire, from a noisy background. The technique 
% is based on a coarse subset and line search and subpixel centerline detection,
% and it can obtain a vertical displacement response of the linear object. 
%
% -------------------------------------------------------------------------+
% 
% If you want to cite our work, please cite the code and the below article.
%
% Principles are described in detail in article:
% Tengjiao Jiang, Gunnstein T. Froseth, Anders Ronnquist, Egil Fagerholt.
...
%
% Code reference:
% Tengjiao Jiang, Gunnstein Thomas Frøseth, Anders Rønnquist, & Egil Fagerholt. 
% (2020, February 23). A vision-based line-tracking technique (Version 1.1). 
% Zenodo. http://doi.org/10.5281/zenodo.3685219.
%
%
% -------------------------------------------------------------------------
%
